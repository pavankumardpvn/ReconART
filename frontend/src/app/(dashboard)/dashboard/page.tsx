...
function ChartTooltip({ active, payload, label }: {
  ...
  return (
    <div className="glass-card rounded-lg border border-[var(--card-border)] bg-[var(--background-elevated)] px-4 py-3 backdrop-blur-xl">
      <p className="mb-1 text-xs text-[var(--foreground-subtle)]">
      ...
      <p className="text-sm font-semibold text-[var(--foreground)]">
        ...
        <span className="text-[var(--foreground-muted)]">Match Rate</span>
      </p>
    </div>
  );
}
